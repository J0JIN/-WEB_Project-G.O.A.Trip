package com.ssafy.goatrip.util;
...
import com.ssafy.goatrip.exception.UnAuthorizedException;
...
//	AccessToken에 비해 유효기간을 길게 설정.
	public String createRefreshToken(String user_id) {
		return create(user_id, "refresh-token", refreshTokenExpireTime);
	}
